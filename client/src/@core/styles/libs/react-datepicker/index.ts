  ...
  return {
    ...
    "& .react-datepicker": {
      ...
      "& .react-datepicker__day": {
        ...
        "&.react-datepicker__day--keyboard-selected.react-datepicker__day--in-selecting-range.react-datepicker__day--selecting-range-start, &.react-datepicker__day--keyboard-selected.react-datepicker__day--range-start.react-datepicker__day--in-range, &.react-datepicker__day--range-start.react-datepicker__day--in-range":
          {
            borderTopLeftRadius: "50% !important",
            borderBottomLeftRadius: "50% !important",
            color: `${theme.palette.common.white} !important`,
        ...
        "&.react-datepicker__day--outside-month:not(.react-datepicker__day--in-selecting-range, .react-datepicker__day--in-range)":
          {
            color: "transparent",
            pointerEvents: "none",
          },
      ...
      "& .react-datepicker__day--in-range:not(.react-datepicker__day--disabled), & .react-datepicker__day--in-selecting-range":
        {
          borderRadius: 0,
